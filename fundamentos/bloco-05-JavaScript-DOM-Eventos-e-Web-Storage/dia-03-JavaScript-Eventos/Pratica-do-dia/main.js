...
techElements.addEventListener('keyup', changeText)
function changeText() {
  let text = input.value
  for (let li of techElements) li.innerText = text;
}
...
//Por conta da propriedade transform :translate vinda da classe tech
